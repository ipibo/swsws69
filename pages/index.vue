    ...
    <div class="font-customFont text-lg transition ease-in-out duration-1000 " :class="currentBgColor">
        <div class="min-h-screen">
            ...
            <div class="text-secondaryBlue h-screen">
                Shared Workspace Weerdjesstraat 69 is the co-working space of
                Erik de Geus, Eva van Boxtel, Guido van der Kooij, Ibo Ibelings,
                Jelle Reith, Katrijn Westland, Sjef van Beers, Sjoerd Mol & Tess
                Havas.
            </div>
        </div>
        ...
        <div id="exhibitions" class="min-h-screen">
            ...
            <text-block class="bg-primaryRed text-secondaryRed float-right"
                >us perspici Lorem ipsum dolor sit, amet consectetur adipisicing
                elit. Eligendi a reiciendis provident, reprehenderit earum odio,
